...
در ***`3bff00`مرحله  اول`3bff00`*** شما می بایست پارامترهای موجود در جدول زیر رو با متد POST به آدرسی که مشخص شده ارسال کنید(به نوع داده ها و نام فیلد توجه کنید)
