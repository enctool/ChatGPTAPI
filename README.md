...
> 
> ولی شما با استفاده از این API, با **کمترین و حداقل تریرن منابع ممکن میتوانید از این سیستم های هوش مصنوعی استفاده کنید!** بصورتیکه با کمترین میزان ram و cpu در یک هاست ارزان قیمت میتوانید از این API استفاده کنید🥳
